...
public class ControlAlojamiento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acc.equals("Nuevo Alojamiento")) {
            ...
            //IMPRIMIENDO POR CONSOLA EL CODIGO QUE RECUPERA DE LA BASE DE DATOS
            System.out.println(codAlo);
            ...
            response.sendRedirect("VistaaAlojamiento.jsp");
        }
        if (acc.equals("Listar Reservas")) {
            modelo.setLis(ServicioReserva.listar());
            response.sendRedirect("VistaaReservaAlo.jsp");
        }
        if (acc.equals("Seleccionar")) {
            ...
            modelo.setFil((Object[]) ServAlo.seleccionarReserva(codRes, codHab, dias, fecRes, fecEnt, fecSal, total, dni));
            response.sendRedirect("VistaaAlojamiento.jsp");
        }
