<%-- 
    Document   : VistaaReservaAlo
    Created on : 10-dic-2024, 22:27:11
    Author     : User
--%>
...
<html>
    <head>
        ...
        <Style> @import "CSS/Estilosss.css" </style>
    </head>
    <body>
    <div class="container">
        ...
        <table>
            ...
            <tr>
                 ...
                 <td><input class="container" type="text" name="fecEnt" size="5" value='<%=f[2] %>'/></td>
                 <td><input class="container" type="text" name="fecSal" size="2" value='<%=f[3] %>'/></td>
                 ...
                 <td><input class="container" type="text" name="codHab" size="7" value='<%=f[5] %>'/></td>
                 <td><input class="container" type="text" name="numdoc" size="5" value='<%=f[7] %>'/></td>
